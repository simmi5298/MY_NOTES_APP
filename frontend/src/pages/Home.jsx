...
const Home = () => {
      ...
      const deleteNote = async data => {
        ...
        try {
          ...
          if (response.data && !response.data.error) {
            alert("Note Deleted Successfully",'delete');
            getAllNotes();
          }
        } catch (error) {
          if (
  ...
  <button className="w-16 h-16 flex items-center justify-center rounded-2xl bg-blue-700 hover:bg-blue-600 absolute right-10 bottom-10" 
   onClick={() => {
